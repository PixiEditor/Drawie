...
public class TextureSample : ArcoSample
{
    public TextureSample(ArcoGraphicsContext context, VecI size) : base(context, size)
    {
    }
    ...
    public override void OnInit()
    {
        ...
        RenderSurface.Canvas.DrawSurface(texture1, 40, 40, new Paint());
        RenderSurface.Canvas.DrawSurface(texture2, 320, 40, new Paint());
        RenderSurface.Canvas.DrawSurface(texture3, 40, 320, new Paint());
        RenderSurface.Canvas.DrawSurface(texture4, 320, 320, new Paint());
    }
}