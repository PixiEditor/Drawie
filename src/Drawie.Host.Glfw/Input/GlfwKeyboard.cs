...
public class GlfwKeyboard : Drawie.Host.Input.IKeyboard
{
    ...
    {
        KeyPressed?.Invoke(this, (Drawie.Host.Input.Key) key, keyCode);
    }

    public bool IsKeyPressed(Host.Input.Key key)
    {
