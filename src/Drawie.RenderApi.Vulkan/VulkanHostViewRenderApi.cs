...
public class VulkanHostViewRenderApi : IVulkanHostViewRenderApi
{
    ...
    public VulkanHostViewRenderApi(VulkanWindowContext context)
    {
    ...
    private void CreateGraphicsPipeline()
    {
        ...
        graphicsPipeline = builder.Create(swapChainImageFormat, ImageLayout.PresentSrcKhr);
    }
